...
echo sqlcmd -S MTWSQL06 -Q "exec msdb.dbo.sp_start_job 'Budget Fact Load - Breakaway'"  >>D:\Jedox\UpdateFinancialsError.txt
sqlcmd -S MTWSQL06 -Q "exec msdb.dbo.sp_start_job 'Budget Fact Load - Breakaway'"  >>D:\Jedox\UpdateFinancialsError.txt